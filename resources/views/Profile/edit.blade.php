...
<div class="main">
  ...
  <form action="/profile/edit" method="post">
    ...
    <div class="select_form">
      <p>名前</p>
      <input class="form_input" type="text" id="name" name="name" value="{{$form->name}}">
    </div>

    <div class="select_form">
      <p>年齢</p>
      <select class="form_input" name="age">
        <option>{{$form->age}}</option>
        <option>未設定</option>
    ...
    <div class="select_form">
      ...
      <select class="form_input" name="annualIncome">
        <option>{{$form->annualIncome}}</option>
        <option>未設定</option>
